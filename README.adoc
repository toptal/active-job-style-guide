...
=== perform_async vs perform_at or perform_in
...
----
# bad
SomeJob.perform_in(5.minutes, 1, 2, 3)
SomeJob.perform_at(5.days.from_now, 1, 2, 3)

# good
SomeJob.set(wait: 5.minutes).perform_async(1, 2, 3)
SomeJob.set(wait_until: 5.days.from_now).perform_async(1, 2, 3)
----
